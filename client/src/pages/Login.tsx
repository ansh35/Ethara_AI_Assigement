...
import { LayoutDashboard, ShieldCheck, Mail, Lock, AlertCircle, ArrowRight } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#09090b] relative overflow-hidden p-6">
      ...
      <div className="absolute top-[-10%] left-[-10%] size-[600px] rounded-full bg-primary/10 blur-[150px] animate-pulse pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] size-[600px] rounded-full bg-blue-600/5 blur-[150px] animate-pulse pointer-events-none" />
      ...
      <div className="w-full max-w-[450px] relative z-10 space-y-8">
        ...
        <Card className="border-white/10 bg-white/[0.02] backdrop-blur-3xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden animate-in slide-in-from-bottom-8 duration-700">
          ...
          <CardHeader className="space-y-1 text-center pt-10 pb-2">
            <CardTitle className="text-sm font-black uppercase tracking-[0.25em] text-muted-foreground/40">Login</CardTitle>
          </CardHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <CardContent className="space-y-6 px-10 pb-8 pt-6">
              ...
              <div className="flex items-center gap-2 px-1 text-[9px] font-black uppercase tracking-widest text-muted-foreground/30 italic">
